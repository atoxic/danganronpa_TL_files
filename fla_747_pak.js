function fla_747_pak()
{
	...
	p.add(loadGIM("005.png", new GIMInfo(456, 53, 3, 16)));
	p.add(loadGIM("006.png", new GIMInfo(300, 60, 3, 16)));
	p.add(loadGIM("007.png", new GIMInfo(252, 21, 3, 16)));
